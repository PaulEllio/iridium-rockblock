...
// Note file transferred from the MX (stm32cubemx) original output

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __STM32U5xx_HAL_CONF_H || STM32U5xx_HAL_CONF_H
#define __STM32U5xx_HAL_CONF_H // Arduino
#define STM32U5xx_HAL_CONF_H // MX
